...
@media (max-width: 430px){
    ...
    elseif (tdc_url_has('/checkout')) {
        ...
        <style>
            ...
            .wc-block-checkout__payment-method .wc-block-components-radio-control-accordion-option {
                margin-bottom: 8px!important;
                padding: 1.07em .875em 1.07em 0em!important;
            }
...
function tdc_custom_js() {
    ...
    ?>
        ...
        */
            ...
            .tbc-discount-wrapper{
                background-image: url(/wp-content/uploads/discount-background-wrapperr.png);
                background-size: contain;
                background-repeat: no-repeat;
                width: 58px;
                height: 58px;
    ...
    <?php 
    /********************************************************
     * Show Custom Sorting dropdown on Products page ends5
     */ 
    }
    ...
    if (tdc_url_has('/product')) {
        ...
        <script type="text/javascript">
            ...
            jQuery(document).ready(function($) {
                ...
                // Updating text on checkout form
